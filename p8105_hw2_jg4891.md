...
***merge by date? not sure ***Write a paragraph about these data; you
...
cigarette butts collected by Gwynnda in June of 2022?

In Mr. Trash wheel data, we have 0 observations. In Professor Trash
Wheel dataset, we have 113 observations, with the total weight of 233.26
tons of trash. In Gwynnda dataset, we have 103 observations. The total
number of cigarette butts collected is 2.4781^{5}. “not sure if this is
right”
